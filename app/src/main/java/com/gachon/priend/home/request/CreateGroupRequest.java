...
public class CreateGroupRequest extends RequestBase<CreateGroupRequest.EResponse> {
    ...
    public CreateGroupRequest(@NonNull Account account, @NonNull String groupName, int password) {
    ...
    protected String getUri() {
        return SERVER_ADDRESS + "/ws/home/entity/group/create";
    }
