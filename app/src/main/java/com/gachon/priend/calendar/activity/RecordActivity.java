...
public class RecordActivity extends AppCompatActivity {
    ...
    private void requestSaveMemo() {
        ...
        if (nowAccount != null) {
            if (memo == null) { // request new memo
                new InsertMemoRequest(nowAccount, animal, newMemo).request(new RequestBase.ResponseListener<InsertMemoRequest.EResponse>() {
                    @Override
                    public void onResponse(InsertMemoRequest.EResponse response, Object[] args) {
                        switch (response) {
                ...
                if (commit.haveChanges()) {
                    new UpdateMemoRequest(nowAccount, animal, commit).request(new RequestBase.ResponseListener<UpdateMemoRequest.EResponse>() {
                        @Override
                        public void onResponse(UpdateMemoRequest.EResponse response, Object[] args) {
                            switch (response) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(this)
                ...
                .setPositiveButton(R.string.record_text_delete, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (nowAccount != null) {
                            new DeleteMemoRequest(nowAccount, animal, memo.getId()).request(new RequestBase.ResponseListener<DeleteMemoRequest.EResponse>() {
                                @Override
                                public void onResponse(DeleteMemoRequest.EResponse response, Object[] args) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         */
        View customActionBar = LayoutInflater.from(this).inflate(R.layout.actionbar_record, null);
         ...
         */
        ImageButton backButton = customActionBar.findViewById(R.id.record_button_back);
        ImageButton saveButton = customActionBar.findViewById(R.id.record_button_save);
        ImageButton deleteButton = customActionBar.findViewById(R.id.record_button_delete);
